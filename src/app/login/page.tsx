...
import { Mail, Lock, Eye, EyeOff, Shield, Users, Film, PhoneCall, BarChart3 } from 'lucide-react'
import { adminApi, setAdminToken, getAdminToken } from '@/lib/api'

export default function LoginPage() {
  const router = useRouter()
  const [email, setEmail] = useState('admin@twinity.ai')
  ...
  useEffect(() => {
    ...
    // Verify the token is actually valid before redirecting — prevents redirect loop
    // when the API is temporarily unreachable
    adminApi.me()
      .then(() => router.replace('/'))
      .catch(() => {}) // token exists but server error — stay on login
  }, [router])
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-white/75 text-base leading-relaxed">
            Complete visibility into users, videos, celebrities and leads — all from one secure place.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-surface-page relative overflow-hidden">
        ...
        {/* Floating blurred orbs — purple on light */}
        <div
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          {/* Header */}
          <div className="mb-8">
            <p className="text-xs font-bold text-brand-purple uppercase tracking-widest mb-2">Admin sign in</p>
